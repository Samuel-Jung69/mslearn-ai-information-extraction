...
def create_analyzer(analyzer, endpoint, key, schema):
...
def main():
    # Load analyzer schema from file
    with open("biz-card.json", "r", encoding="utf-8") as f:
        schema = f.read()
    ...
    # Create the analyzer
    create_analyzer(analyzer, endpoint, key, schema)
